...
func AHRSupdate(gx, gy, gz, ax, ay, az, mx, my, mz float64) {
	...
	var float w_err_x, w_err_y, w_err_z 	// estimated direction of the gyroscope error (angular)
	var hx, hy, hz float64                  // computed flux in the earth frame
	...
	if !((ax == 0.0) && (ay == 0.0) && (az == 0.0)) {
		...
		// w_err_x = _2q0*SEqHatDot_2 - _2q1*SEqHatDot_1 - _2q2*SEqHatDot_4 + _2q3*SEqHatDot_3
		// w_err_y = _2q0*SEqHatDot_3 - _2q1*SEqHatDot_4 - _2q2*SEqHatDot_1 + _2q3*SEqHatDot_2
		// w_err_z = _2q0*SEqHatDot_4 - _2q1*SEqHatDot_3 - _2q2*SEqHatDot_2 + _2q3*SEqHatDot_1
